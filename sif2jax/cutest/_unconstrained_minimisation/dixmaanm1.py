...
class DIXMAANM1(AbstractUnconstrainedMinimisation):
    """Dixon-Maany test problem (version M1).

    This is a variable-dimension unconstrained optimization problem from the
    Dixon-Maany family. It's a variant of DIXMAANM with beta=0, so elements/groups
