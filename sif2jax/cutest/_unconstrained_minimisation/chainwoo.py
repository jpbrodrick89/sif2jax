...
class CHAINWOO(AbstractUnconstrainedMinimisation):
    ...
    def objective(self, y, args):
        ...
        # Get the variable values using stride-2 slices
        x_2i_minus_1 = y[: 2 * ns : 2]  # 0, 2, 4, ...
        x_2i = y[1 : 2 * ns + 1 : 2]  # 1, 3, 5, ...
        x_2i_plus_1 = y[2 : 2 * ns + 2 : 2]  # 2, 4, 6, ...
        x_2i_plus_2 = y[3 : 2 * ns + 3 : 2]  # 3, 5, 7, ...
