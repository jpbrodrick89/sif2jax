...
class NCVXBQP1(AbstractBoundedQuadraticProblem):
    """NCVXBQP1 problem - a non-convex bound constrained quadratic program.
    ...
    def expected_result(self):
        ...
        raise NotImplementedError("Expected result not available for NCVXBQP1")

    @property
    def expected_objective_value(self):
        """Expected objective value at the solution."""
        # From SIF file: -1.99558D+06 for n=100
        return None  # Not available for general n
